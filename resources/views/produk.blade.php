...
<section class="py-16 text-center">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-6">
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">Minyak Sawit Mentah (CPO)</h3>
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">Kernel Oil</h3>
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">Pupuk Organik</h3>
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">Palm Kernel Cake (PKC)</h3>
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">Biodiesel Sawit</h3>
    ...
    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
      ...
      <h3 class="text-lg font-bold text-gray-700">RBD Olein</h3>
