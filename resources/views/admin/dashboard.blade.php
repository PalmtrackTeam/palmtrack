                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                    ...
                    <div class="bg-white rounded-xl card-shadow p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.riwayat-laporan-masalah') }}" class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <i class="fas fa-list-alt text-gray-400 w-6 mr-3"></i>
                                <span class="text-gray-700">Riwayat Laporan</span>
                            </a>
