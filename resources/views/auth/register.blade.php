        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                ...
                <select name="role" required
                    ...
                    <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Mandor</option>
            ...
            <!-- Status Tinggal -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Status Tinggal *</label>
                <select name="status_tinggal" required
                        class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white px-3 py-2">
                    <option value="">Pilih Status Tinggal</option>
                    <option value="barak" {{ old('status_tinggal') == 'barak' ? 'selected' : '' }}>Barak</option>
                    <option value="keluarga_barak" {{ old('status_tinggal') == 'keluarga_barak' ? 'selected' : '' }}>Keluarga Barak</option>
                    <option value="luar" {{ old('status_tinggal') == 'luar' ? 'selected' : '' }}>Luar</option>
                </select>
            </div>
