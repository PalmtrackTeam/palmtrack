...
{
    $blok = \App\Models\BlokLadang::select('id_blok', 'kategori')->groupBy('kategori')->get();
    ...
    public function register(Request $request)
    {
        ...
        $user = User::create([
            ...
            // blok ladang wajib
// Cari blok berdasarkan kategori
$blokDipilih = \App\Models\BlokLadang::where('kategori', $request->id_blok)->first()->id_blok;
